...
/* 
    ...
    <COLUMN KEY="false" LENGTH="50" NAME="order_increment_id" NULLABLE="true" TYPE="id_String"/>
    <COLUMN KEY="false" LENGTH="50" NAME="order_created_at" NULLABLE="true" TYPE="id_String"/>
    <COLUMN KEY="false" LENGTH="50" NAME="total_qty" NULLABLE="true" TYPE="id_String"/>
    <COLUMN KEY="false" LENGTH="50" NAME="shipment_id" NULLABLE="true" TYPE="id_String"/>
    <COLUMN KEY="false" LENGTH="50" NAME="items" NULLABLE="true" TYPE="id_String"/>
    <COLUMN KEY="false" LENGTH="50" NAME="tracks" NULLABLE="true" TYPE="id_String"/>
    <COLUMN KEY="false" LENGTH="50" NAME="comments" NULLABLE="true" TYPE="id_String"/>
...
*/
    ...
    private org.altic.magentojconnector.magento.api.SalesOrderShipmentItemEntity[] items;

    private org.altic.magentojconnector.magento.api.SalesOrderShipmentTrackEntity[] tracks;

    private org.altic.magentojconnector.magento.api.SalesOrderShipmentCommentEntity[] comments;
    ...
    public SalesOrderShipmentEntity(
           ...
           org.altic.magentojconnector.magento.api.SalesOrderShipmentItemEntity[] items,
           org.altic.magentojconnector.magento.api.SalesOrderShipmentTrackEntity[] tracks,
           org.altic.magentojconnector.magento.api.SalesOrderShipmentCommentEntity[] comments) {
     ...
     * @return items
     */
    public org.altic.magentojconnector.magento.api.SalesOrderShipmentItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(org.altic.magentojconnector.magento.api.SalesOrderShipmentItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return tracks
     */
    public org.altic.magentojconnector.magento.api.SalesOrderShipmentTrackEntity[] getTracks() {
        return tracks;
    }
     ...
     * @param tracks
     */
    public void setTracks(org.altic.magentojconnector.magento.api.SalesOrderShipmentTrackEntity[] tracks) {
        this.tracks = tracks;
    }
     ...
     * @return comments
     */
    public org.altic.magentojconnector.magento.api.SalesOrderShipmentCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(org.altic.magentojconnector.magento.api.SalesOrderShipmentCommentEntity[] comments) {
        this.comments = comments;
    }
